...
public class GreetingServiceTest {
	...
	public static WebArchive createDeployment() {
		WebArchive archive = ShrinkWrap.create(WebArchive.class, "rest-http-secured-test.war")
    ...
    public void resource() {
        ...
        try {
            WebTarget target = client.target("http://localhost:9080/rest-http-secured-test")
                    .path("api")
                    .path("greeting");
